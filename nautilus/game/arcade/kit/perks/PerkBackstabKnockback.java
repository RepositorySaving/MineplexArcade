...
public class PerkBackstabKnockback extends Perk
{
  ...
  {
    super("Backstab", new String[] {C.cGray + "+250% Knockback from behind opponents." });
  }
  ...
  public void Damage(CustomDamageEvent event)
  {
    ...
    if (check.subtract(from).length() < 0.8D)
    {
      ...
      event.AddKnockback("Backstab Knockback", 2.5D);
      

      damagee.getWorld().playSound(damagee.getLocation(), Sound.PIG_DEATH, 1.0F, 2.0F);
      return;
    }
  }
}
