...
public class PerkSlimeSlam extends Perk
{
  ...
  public void Leap(PlayerInteractEvent event)
  {
    ...
    UtilAction.velocity(player, player.getLocation().getDirection(), 1.2D, false, 0.0D, 0.2D, 1.2D, true);
  ...
  public void DoSlam(Player damager, LivingEntity damagee) {
    ...
    this.Manager.GetDamage().NewDamageEvent(damager, damagee, null, 
      EntityDamageEvent.DamageCause.CUSTOM, damage / 2.0D, true, true, false, 
