...
public class PerkKnockbackSnow extends Perk
{
  ...
  {
    super("Frosty Knockback", new String[] {mineplex.core.common.util.C.cGray + "You deal " + (int)(power * 100.0D) + "% Knockback to enemies on snow." });
  ...
  public void Knockback(CustomDamageEvent event)
  {
    ...
    event.AddKnockback("Knockback Snow", this._power);
  }
}
