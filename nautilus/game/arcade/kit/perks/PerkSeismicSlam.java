...
public class PerkSeismicSlam extends Perk
{
  ...
  public void Leap(PlayerInteractEvent event)
  {
    ...
    mineplex.core.common.util.UtilAction.velocity(player, vec, 1.0D, true, 1.0D, 0.0D, 1.0D, true);
              ...
              if (!cur.equals(player))
              {
                ...
                if (UtilEnt.isGrounded(player))
                {
                  ...
                  this.Manager.GetDamage().NewDamageEvent(cur, player, null, 
                    EntityDamageEvent.DamageCause.CUSTOM, damage * ((Double)targets.get(cur)).doubleValue() + 0.5D, true, true, false, 
  ...
  public void Knockback(CustomDamageEvent event) {
    ...
    event.AddKnockback(GetName(), 2.4D);
  }
}
