...
public class SuperSmashTeam extends TeamGame
{
  ...
  {
    super(manager, nautilus.game.arcade.GameType.SmashTeams, new Kit[] {new nautilus.game.arcade.game.games.smash.kits.KitSkeleton(manager), new KitGolem(manager), new nautilus.game.arcade.game.games.smash.kits.KitSpider(manager), new nautilus.game.arcade.game.games.smash.kits.KitSlime(manager), new nautilus.game.arcade.game.games.smash.kits.KitCreeper(manager), new nautilus.game.arcade.game.games.smash.kits.KitEnderman(manager), new nautilus.game.arcade.game.games.smash.kits.KitSnowman(manager), new nautilus.game.arcade.game.games.smash.kits.KitWolf(manager), new nautilus.game.arcade.game.games.smash.kits.KitBlaze(manager), new nautilus.game.arcade.game.games.smash.kits.KitWitch(manager), new nautilus.game.arcade.game.games.smash.kits.KitChicken(manager), new nautilus.game.arcade.game.games.smash.kits.KitSkeletalHorse(manager), new nautilus.game.arcade.game.games.smash.kits.KitPig(manager), new nautilus.game.arcade.game.games.smash.kits.KitSkySquid(manager), new nautilus.game.arcade.game.games.smash.kits.KitWitherSkeleton(manager), new nautilus.game.arcade.game.games.smash.kits.KitMagmaCube(manager) }, new String[] {"Each player has 3 respawns", "Attack to restore hunger!", "Last player alive wins!" });
  ...
  public void Hunger(UpdateEvent event) {
    ...
    this.hungerTick = ((this.hungerTick + 1) % 6);
