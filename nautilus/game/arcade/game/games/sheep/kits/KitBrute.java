  ...
  extends Kit
{
  ...
  {
    super(manager, "Brute", KitAvailability.Blue, new String[] {"Strong enough to throw things around!" }, new Perk[] {new PerkThrower(manager) }, EntityType.ZOMBIE, new ItemStack(Material.IRON_SWORD));
  }
