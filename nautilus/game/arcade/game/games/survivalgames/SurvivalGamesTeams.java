...
public class SurvivalGamesTeams extends TeamGame
{
  ...
  {
    super(manager, nautilus.game.arcade.GameType.SurvivalGamesTeams, new nautilus.game.arcade.kit.Kit[] {new nautilus.game.arcade.game.games.survivalgames.kit.KitAxeman(manager), new nautilus.game.arcade.game.games.survivalgames.kit.KitKnight(manager), new nautilus.game.arcade.game.games.survivalgames.kit.KitArcher(manager), new nautilus.game.arcade.game.games.survivalgames.kit.KitBrawler(manager), new nautilus.game.arcade.game.games.survivalgames.kit.KitAssassin(manager), new nautilus.game.arcade.game.games.survivalgames.kit.KitBeastmaster(manager), new nautilus.game.arcade.game.games.survivalgames.kit.KitBomber(manager), new nautilus.game.arcade.game.games.survivalgames.kit.KitNecromancer(manager) }, new String[] {"Search for chests to find loot", "Slaughter your opponents", "Stay away from the Deep Freeze!", "Last team alive wins!" });
  ...
  public void ParseData()
  {
    ...
    this._spawn = UtilWorld.averageLocation(allSpawns);
