...
public class SilencingArrow extends SkillActive
{
  ...
  private HashSet<Player> _silence = new HashSet();
  ...
  public SilencingArrow(SkillFactory skills, String name, IPvpClass.ClassType classType, ISkill.SkillType skillType, int cost, int levels, int energy, int energyMod, long recharge, long rechargeMod, boolean rechargeInform, Material[] itemArray, Action[] actionArray)
  {
  ...
  public void ShootBow(EntityShootBowEvent event)
  {
    ...
    if (!this._silence.remove(player)) {
      return;
    }
  ...
  public void Damage(CustomDamageEvent event)
  {
    ...
    this.Factory.Condition().Factory().Silence(GetName(), damagee, damager, 3 + 3 * level, true, true);
  ...
  public void Particle(UpdateEvent event)
  {
    ...
    {
      mineplex.core.common.util.UtilParticle.PlayParticle(UtilParticle.ParticleType.SPELL, ent.getLocation(), 0.0F, 0.0F, 0.0F, 0.0F, 1);
    }
  }
